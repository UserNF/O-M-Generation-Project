...
class App(customtkinter.CTk):
    ...
    def populate_literaturelayout(self):
        ...
        #Create Button
        self.sidebar_button_2 = customtkinter.CTkButton(self, command=self.populate_literaturelayout, text="Add New Literature...")
        self.sidebar_button_2.grid(row=0, column=1, padx=20, pady=85, sticky="nw")
